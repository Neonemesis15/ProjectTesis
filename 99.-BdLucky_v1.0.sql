...
INSERT INTO `usuarios` (`idusuario`, `apellidos`, `nombres`, `usuario`, `password`, `autorizacion`) VALUES (1,'Balta Alva','Victor Manuel','vbalta','G�_+�\�k\�ӏ�\r�','ADMIN'),(2,'Vasquez Paragulla','Juan Julio','jvasquez','G�_+�\�k\�ӏ�\r�','CLIENT');
